...
class SupportTeam(models.Model):
    ...
    picking_type_id=fields.Many2one('stock.picking.type',string='Tipo de Operación Entrada')
    picking_type_ids=fields.Many2one('stock.picking.type',string='Tipo de Operación Salida')
